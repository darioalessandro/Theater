        ...
        describe("BLEPeripheral") {
            ...
            describe("lifecycle", {
                ...
                it("should start with no listeners") {
                    ...
                    expect(system.selectActor(actorPath: "testo/user/BLEPeripheral1")).toEventually(beIdenticalTo(peripheral.this), timeout: 10, pollInterval: 1, description: "peripheral never died")
                }

                it("should stop when requested") {
                    peripheral.this ! Actor.Harakiri(sender: nil)
                    expect(system.selectActor(actorPath: "BLEPeripheral1")).toEventually(beNil(), timeout: 10, pollInterval: 1, description: "peripheral never died")
                }
            ...
            describe("states", {
                ...
                it("should transition to advertising if it is forced to and then stop if required") {
                    ...
                    peripheral.this ! Actor.Harakiri(sender: nil)
                    expect(system.selectActor(actorPath: "BLEPeripheral3")).toEventually(beNil(), timeout: 10, pollInterval: 1, description: "peripheral never died")
                }
